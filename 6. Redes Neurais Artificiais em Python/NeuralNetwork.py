...
def ajuste_peso1(oculta, delta, pesos,taxa_aprendizado=0.6, momento=1): # camada oculta
    # (entrada * delta) = lista
    lista = []
...
def ajuste_peso0(entradas, delta, pesos, taxa_aprendizado=0.6, momento=1): # camada entrada
    # entrada * delta
    lista = []
